...
// ============================================
// TestMu AI Browser Cloud SDK Parity Types
// ============================================
...
// -------------------- Session Configuration (Full TestMu AI Parity) --------------------
export type BrowserAdapter = 'puppeteer' | 'playwright' | 'selenium';

export interface SessionConfig {
    // Original browser-cloud options
    ...
    // TestMu AI Browser Cloud SDK Parity Options
    blockAds?: boolean;
...
export interface Session {
    ...
    // TestMu AI Browser Cloud SDK Parity Fields
